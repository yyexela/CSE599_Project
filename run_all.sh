...
#   MNIST  - full shuffle
python -u project.py --epochs=20 --restarts=15 --new_labels=shuffle_full --dataset=MNIST --top_dir=shuffle_full_mnist_mlp --device=cuda:1 > shuffle_full_mnist_mlp.txt 2>&1 &
...
python -u project.py --epochs=20 --restarts=15 --new_labels=shuffle_full --dataset=CIFAR10 --top_dir=shuffle_full_cifar10_mlp --device=cuda:1 --learning_rate=0.00005 > shuffle_full_cifar10_mlp.txt 2>&1 &
...
#   MNIST - full shuffle
python -u project.py --epochs=20 --restarts=15 --new_labels=shuffle_full --dataset=MNIST --top_dir=shuffle_full_mnist_cnn --model=CNN --learning_rate=0.01 --device=cuda:1 > shuffle_full_mnist_cnn.txt 2>&1 &
#   CIFAR10 - class shuffle
...
#   CIFAR10 - full shuffle
python -u project.py --epochs=20 --restarts=15 --new_labels=shuffle_full --dataset=CIFAR10 --top_dir=shuffle_full_cifar10_cnn --learning_rate=0.001 --model=CNN --device=cuda:1 > shuffle_full_cifar10_cnn.txt 2>&1 &
